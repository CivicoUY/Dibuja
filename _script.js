...
function grafica(div, dataGraficar){
  ...
  /* En esta parte está el dominio, tenemos que modificar esto si queremmos salir de la lógica 0-100 y el año */
  c.x.domain([inicio, 2016])
  c.y.domain([200.000, 300.000])
  /* Buscar función tickFormat*/
  ...
  var drag = d3.drag()
    .on('drag', function(){
      ...
      if (!completed && d3.mean(yourData, ƒ('defined')) == 1){
        completed = true
        clipRect.transition().duration(4000).attr('width', c.x(2018))
